...
type
  ...
  private
    ...
    FEngine: TAggFontEngine;

    FChangeStamp: Integer;

    FDeltaX, FDeltaY: Double;
  ...
  public
    constructor Create(Engine: TAggFontEngine; MaxFonts: Cardinal = 32);
    destructor Destroy; override;
...
constructor TAggFontCacheManager.Create(Engine: TAggFontEngine; MaxFonts: Cardinal = 32);
begin
